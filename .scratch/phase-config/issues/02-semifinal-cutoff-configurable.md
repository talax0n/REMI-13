...
Verified implemented. Admin can choose Top 10 or Top 20 before semifinal pairing, the choice is persisted in `tournament_state`, and the semifinal path uses the shared pairing engine.
