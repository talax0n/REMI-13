...
Verified implemented. The shuffle engine pads non-multiple player counts with dummy seats so generated tables contain exactly five seats, dummy seats are excluded from opponent history/scoring/export player rows, and public table display shows them as empty seats rather than real players.
